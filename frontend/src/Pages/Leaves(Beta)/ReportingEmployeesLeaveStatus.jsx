import { Autocomplete, Box, Button, Card, FormControl, Grid, InputLabel, MenuItem, Modal, Select, TextField, Typography } from '@mui/material'
...
export const ReportingEmployeesLeaveStatus = () => {
      ...
      isloading?<Loading></Loading>:
        <Box style={SerchingComponetsstyle.firstBox}>
         ...
         <Typography variant='h6' style={SerchingComponetsstyle.typographystyle}>
            REPORTING EMPLOYEES LEAVE STATUS</Typography>
            {
...
<CustomDatagrid rows={allReview} CustomToolBar={CustomToolBar} rowId={getrowId} columns={columns} sortingfield={"leaveDate"} rowclickhandle={handlerowclick} filterchangehandle={handlefilter}></CustomDatagrid>
